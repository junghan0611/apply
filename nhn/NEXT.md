...
- Image CLI: `node ~/.claude/skills/command-glgimage/gemini-image-gen.mjs --prompt-file PROMPT.txt --aspect-ratio <ratio> --image-size 2K --output images/<name>.png --json`. JSON의 `path`가 실제 확장자다.
