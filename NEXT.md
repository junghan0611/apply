# NOW — 2026-08-04 카카오뱅크 DW 제출, 현대오토에버 사전 연습, 다음 지원 준비
...
- [2026-08-04] **토스 AI Engineer (Platform)·인핸스 FDE·루닛 Senior AX Engineer 불합격 통보를 회수했다.** 세 건을 `rejected`로 닫고, 실제 제출 스냅샷은 그대로 보존한다.
