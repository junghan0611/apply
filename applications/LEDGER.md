...
| Upstage | AI Engineer - Agents | replied | **2026-08-01** · **서류전형 합격 2026-08-19** | 그리팅 (자체 도메인) | AI Engineer + **국문 자기소개서 2쪽** + 포트폴리오 12쪽 | `upstage--ai-engineer-agents` |
...
| IGNITE | AI Developer | replied | **2026-08-01** · **코딩테스트·실무형 과제 안내 2026-08-12** | 회사 자체 ATS (ninehire, `ignite.ninehire.site` · 상시) · 지원경로 `채용포털` | **이력서+경력기술서 8쪽 합본** + Portfolio 12쪽 + **실제 서술형 260·286·260자** | `ignite--ai-developer` |
