...
| 지원일 | — |
| 경로 | **원티드 자체 지원** (`wd/384691`) — `out_link: null` 실측 (2026-09-18) |
...
| 항목 | 값 | 영수증 |
|---|---|---|
| 공고 상태 | `active` — 살아 있다 | `GET /api/chaos/jobs/v1/384691/details` (2026-09-18 실측) |
...
| 국적·비자 칸 | 해당 없음 — `visa_information: null` (글로벌 포지션 아님) | 〃 `visa_information` |
