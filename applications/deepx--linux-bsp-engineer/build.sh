...
#   ./build.sh
#
# 산출: submit/KimJunghan_DEEPX_BSP_Application.pdf
...
RESUME_CUT=../../resume/build/KimJunghan_Resume_Embedded_Software_Engineer.pdf
OUT=submit/KimJunghan_DEEPX_BSP_Application.pdf
...
text=$(pdftotext "$OUT" -)
for needle in 'RISC-V' 'Boundaries' 'Junghan Kim'; do
	case $text in
	*"$needle"*) ;;
